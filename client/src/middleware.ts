 ...
 * If the request is not for the API, it passes through to regular Astro handling.
 * 
 * @param {import('astro').APIContext} context - The Astro context containing the request
